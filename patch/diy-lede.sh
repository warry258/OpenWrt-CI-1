...
sed -i 's/samba4/samba/g' openwrt/package/lean/autosambafiles/20-smb
sed -i 's/0666/0777/' openwrt/package/lean/autosambafiles/20-smb

#替换automount
#rm -rf openwrt/package/lean/automountfiles/15-automount
#cp -r files/15-automount openwrt/package/lean/automountfiles
